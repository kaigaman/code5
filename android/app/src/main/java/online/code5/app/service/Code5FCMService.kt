package online.code5.app.service
...
import online.code5.app.Code5App
import online.code5.app.MainActivity
import online.code5.app.R
import online.code5.app.network.models.FcmTokenRequest
...
class Code5FCMService : FirebaseMessagingService() {
    ...
    private fun showNotification(title: String, body: String, data: Map<String, String>) {
        ...
        val notification = NotificationCompat.Builder(this, Code5App.NOTIFICATION_CHANNEL_ID)
    ...
    private fun registerTokenOnServer(token: String) {
        CoroutineScope(Dispatchers.IO).launch {
            val prefs = this@Code5FCMService.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
    ...
    companion object {
        private const val TAG = "Code5FCM"
        private const val PREFS_NAME = "code5_fcm"
